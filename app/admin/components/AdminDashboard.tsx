...
Step 3.5: Move Analytics Page to Admin
File: app/admin/analytics/page.tsx (NEW FILE)
...
Step 3.6: Create Admin Analytics Component
File: app/admin/analytics/components/AdminAnalytics.tsx (NEW FILE)

// app/admin/analytics/components/AdminAnalytics.tsx
'use client';
